...
_REPORT_HEADER_TEMPLATE = """Based on all the research{source_context}, create a comprehensive, well-structured answer to the overall research brief:
<Research Brief>
{research_brief}
</Research Brief>
...
DRAFT_REPORT_GENERATION_PROMPT = _build_report_prompt(
    source_context=" in your knowledge base",
)

REPORT_GENERATION_WITH_DRAFT_INSIGHT_PROMPT = _build_report_prompt(
